...
information_request = input('Добавит товар? y/n: ')
stock = []
product = {}
names = []
prices = []
...
while information_request == 'y':
    ...
    stock.append((i, product))
    information_request = input('Добавит еще товар? y/n: ')
    i += 1

if len(stock) != 0:
    statistics = {'name': names, 'price': prices, 'quantity': quantitys, 'unit': units}
    print(stock)
    print(statistics)
